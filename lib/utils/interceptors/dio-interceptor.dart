...
class DioClient {
  ...
  static BehaviorSubject<dynamic> accessTokenSubject =
      new BehaviorSubject.seeded(null);
  static Stream<dynamic> get accessToken$ =>
      accessTokenSubject.asBroadcastStream();
  ...
  static Dio _reloginDio = Dio(BaseOptions(
      baseUrl: "${Environment.baseUrl}/api",
      contentType: 'application/json;charset=utf-8',
      responseType: ResponseType.json,
      headers: {
  ...
  static Dio dioWithResponseType(ResponseType r, {String? baseUrl}) =>
      createDio(responseType: r, baseUrl: baseUrl);

  static Dio createDio(
      {ResponseType responseType = ResponseType.json, String? baseUrl}) {
