...
class _MyMapView extends State<MyMapView> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<bool> gps) {
        if(!gps.hasData || (gps.hasData && gps.data! == false)) {
                        ...
                        <!DOCTYPE html>
                          <html lang="en">
                            ...
                            <script>
                              ...
                              let x1 = ${position.data!.latitude};
                              let y1 = ${position.data!.longitude};

                              let x2 = ${targetLocation.data!['latitude']};
                              let y2 = ${targetLocation.data!['longitude']};

                              // let x2 = 3.597036314282042;
                              // let y2 = 98.67109562745719;

                              let D = distanceMeter(x1,y1,x2,y2) * 2;
                              let radius = ${targetLocation.data!['radius']} * 2
                              const ratios = [
                                1128.497220,
                                2256.994440,
                                4513.988880,
