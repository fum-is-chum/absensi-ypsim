          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  item.file != null ? item.file!.substring(item.file!.lastIndexOf('/') + 1, item.file!.length) :
                  'Tidak ada lampiran',
                  style: TextStyle(decoration: item.file != null ? TextDecoration.underline : TextDecoration.none),
                ),
                SizedBox(height: 16,),
                (() {
                  if(item.file != null) {
